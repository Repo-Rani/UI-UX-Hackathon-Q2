...
const SignUp = () => {
  ...
  <p className="text-[14px] font-halvetica font-normal text-[#333333]">
    Remember me?
          ...
          <button className="relative top-[180px] left-[35px] w-[360px] h-[44px] bg-[#FF9F0D] text-white font-halvetica text-[16px] font-normal flex justify-center items-center hover:bg-[#ffffff] hover:text-[#FF9F0D] hover:border-[1px] hover:border-[#FF9F0D] transition-all duration-300 ease-in-out">
            Sign Up
          </button>
