...
export default function Home() {
  ...
  return (
    <div>
      ...
      {!isLoading && (
        <>
          <div className='bg-[#0D0D0D] w-full max-w-[1920px] xlg:h-[8000px] md:h-[6700px] h-[7950px]'>
            <HeaderHero />
            <div className="absolute xlg:top-[7800px] top-[7060px] xsm:top-[7200px]  md:top-[6100px] sm:top-[7900px]">
              <Footer />
            </div>
          </div>
        </>
