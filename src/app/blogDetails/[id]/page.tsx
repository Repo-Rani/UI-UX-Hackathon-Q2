    ...
    <>
      ...
      <section className="w-[872px] h-[3138px] absolute top-[620px] left-[300px] ">
        ...
        <div className="border-[#E0E0E0] border-[1px] absolute top-[2070px] w-[872px] h-[60px]  flex justify-center gap-[300px] items-center">
          ...
          <div className="w-[187px] h-[24px] flex justify-center gap-[20px] items-center">
            ...
            <div className="flex gap-[20px] items-center">
              <FaFacebookF className="h-[20px] w-[20px] text-[#4F4F4F]"/>
              <FaTwitter className="w-[20px] h-[20px] text-[#4F4F4F]"/>
           <FaInstagram className="w-[20px] h-[20px] text-[#4F4F4F]"/>
          <FaPinterest  className="w-[20px] h-[20px] text-[#4F4F4F]"/>
        ...
        <div className="w-[872px] h-[484px]  relative top-[500px]">
          ...
          ></textarea>
          <button className="w-[212px] h-[56px] relative top-[100px] py-[16p] px-[48px] bg-[#FF9F0D] text-white hover:border-[#ff9f0d] hover:bg-white hover:text-[#ff9f0d] hover:border-[1px] hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer font-normal text-[16px] font-helvetica whitespace-nowrap">
            Post a comment
          </button>
        </div>
