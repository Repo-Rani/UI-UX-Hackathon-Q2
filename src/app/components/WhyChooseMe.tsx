    ...
    <div className="w-[1320px] h-[716px]  overflow-hidden">
      <div>
        ...
        <Image
          ...
          height={231}
          width={281}
          className="rounded-[6px] relative left-[373px] bottom-[234px]"
        />
        <Image
          src="/ci3.svg"
          alt="food-image"
          height={306}
          width={244}
          className="rounded-[6px] relative bottom-[220px] "
        />
        <Image
          src="/ci4.svg"
          alt="food-image"
          height={226}
          width={221}
          className="rounded-[6px] relative  left-[254px] bottom-[525px] "
        />
        <Image
          src="/ci5.svg"
          alt="food-image"
          height={168}
          width={161}
          className="rounded-[6px] relative  left-[485px] bottom-[750px] "
        />
        <Image
          src="/ci6.svg"
          alt="food-image"
          height={166}
          width={161}
          className="rounded-[6px] relative  left-[485px] bottom-[738px] "
        />
      </div>
      ...
      <div>
        <span 
          data-aos="fade-right"
        data-aos-delay="100"
        className="w-[175px] h-[40px] font-greatvibes font-normal text-[32px] text-[#ff9f0d] absolute left-[800px] bottom-[675px] whitespace-nowrap">
          Why Choose Us
        </span>
        <h2
          data-aos="fade-left"
        data-aos-delay="100"
        className=" relative left-[800px] bottom-[1400px] font-helvetica font-bold text-[48px] text-[#ffffff] ">
        ...
        <p
          data-aos="fade-right"
        data-aos-delay="200"
        className="w-[526px] h-[120px] relative left-[800px] bottom-[1360px] font-inter font-normal text-[16px] leading-[24px] text-[#ffffff]">
        ...
        data-aos-delay="300"
          className="flex flex-col   gap-[15px]">
            ...
            className="w-[102px] h-[100px] rounded-[6px] flex justify-center items-center bg-[#FF9F0D]">
              <Image
                src="/Hamburger.svg"
                alt="food-icon"
                width={50}
      ...
      <div
          data-aos="flip-up"
        data-aos-delay="300"
      className="w-[374px] h-[93px] rounded-[6px] relative left-[800px] bottom-[1290px] bg-[#FF9F0D]">
