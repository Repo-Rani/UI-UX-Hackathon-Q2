  ...
  return (
    <div className='w-[1320px] h-[716px]'>
        <div>
         ...
         <div>
                <span className='w-[175px] h-[40px] font-greatvibes font-normal text-[32px] text-[#ff9f0d] relative left-[800px] bottom-[1400px]'>Why Choose Us</span>
                <h2 className='w-[433px] h-[112px] relative left-[800px] bottom-[1400px] font-roboto font-bold text-[48px] text-[#ffffff]'><span className='text-[#ff9f0d]'>Ex</span>tra ordinary taste
                And Experienced </h2>
      ...
      <div className='w-[374px] h-[93px] rounded-[6px] relative left-[800px] bottom-[1290px] bg-[#FF9F0D]'>
        <div className="w-[374px] h-[93px] rounded-[6px] bg-[#ffffff] ml-[10px]">
          <div className="flex items-center justify-center gap-[75px] text-center pt-[20px]">
            <span className="font-roboto text-bold text-[48px] leading-[56px] text-[#FF9F0D]">
              30+
            </span>
            <div className="flex flex-col items-centergap-[2px]">
              ...
              <span className="font-roboto text-[24px] font-bold text-[#1e1e1e] leading-[20px]">
                Experience
              </span>
            </div>
          </div>
