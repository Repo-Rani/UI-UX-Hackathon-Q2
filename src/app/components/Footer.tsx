...
const Footer = () => {
  return (
    <>
      <footer className=" md:w-[1920px] h-[774.15px] relative bg-black text-white flex justify-between gap-[20px] items-center flex-col">
        ...
        <div
          className="w-[1920px] h-[100px]  bg-[#4F4F4F] 
 text-white flex items-center"
        ...
        <Image
          ...
          height={294}
          width={244}
          className="h-[294px] w-[244px] absolute bottom-0 right-[-14px] "
        />
      </footer>
    </>
  );
