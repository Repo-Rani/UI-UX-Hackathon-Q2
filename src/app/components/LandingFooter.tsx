...
const Footer = () => {
  ...
  >
    Subscribe Now
        ...
        <div
          className="w-[390px] md:w-[1920px] xl:w-[1484px] xxl:w-[1920px] h-[100px]  bg-[#ff9f0d] 
 text-white flex items-center md:flex-row flex-col"
        ...
        <Image
          ...
          height={294}
          width={244}
          className="w-[120px] h-[148px] md:h-[294px] md:w-[244px] xl:w-[200px] xl:h-[250px] xxl:w-[244px] xxl:h-[294px] absolute bottom-0 right-0 md:right-[-14px] "
        />
      </footer>
    </>
  );
