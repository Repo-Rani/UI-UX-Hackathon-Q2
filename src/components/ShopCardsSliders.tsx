...
const ShopCardsSliders = ({id,  image, title, price, discountPrice, sell }: SliderShopCardProps) => {
  return (
    ...
    <div className="w-[300px] h-[240px] sm:w-[170px] sm:h-[145px] lg:w-[312px] lg:h-[350px] relative group">
      {/* Image Section */}
      <div className="relative">
        <Image
          ...
          height={267}
          width={312}
          className="w-[390px] h-[240px] sm:w-[170px] sm:h-[145px] lg:w-[312px] lg:h-[267px] object-cover rounded-md"
        />
        {/* Hidden Div */}
