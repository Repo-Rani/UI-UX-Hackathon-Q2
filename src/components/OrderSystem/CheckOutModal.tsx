...
const CheckoutModal = ({
      ...
      const handleSendEmail = async () => {
        try {
          ...
          const customerEmailParams = {
            to_email: userData.email || "ranimiss@968gmail.com",
            ...
            support_email: "ranimiss@968gmail.com",
            support_phone: "+923022886058",
            payment_method: "COD",
            company_name: "Foodtuck",
          };
          ...
          const storeEmailParams = {
            ...
            to_email: "ranimiss@968gmail.com",
          };
  ...
  const handleCheckout = async (userData: any) => {
    ...
    const addressFrom = {
      name: "Foodtuck",
      street1: "Sector-4 North Karachi",
      city: "Karachi",
      state: "Sindh",
      zip: "071500",
      country: "Pakistan",
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end gap-6">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-darkPrimary text-white rounded-md hover:bg-[#ff90fd] disabled:opacity-50"
                    disabled={isLoading}
                  >
                    Submit
                  </button>
                ...
                {trackingData && trackingData.trackingDetails && (
                  <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                    ...
                    <p>
                      ...
                      {`Sector-4 North| Karachi, Sindh - Pakistan`}
                    </p>
                    <p>
