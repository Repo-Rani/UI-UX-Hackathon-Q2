...
// const LandingFooter = () => {
//   return (
// <footer className='min-h-screen  md:h-[774px] bg-purple-300 text-white flex flex-col justify-center gap-5 items-center w-full'>
//       <div className="w-full bg-red-500 flex justify-between flex-col items-center">
//         hye
//         </div>
// </footer>
//   )
...
//               About Us
//             </h2>
//             <p className="font-inter font-normal text-white text-[12px] md:text-[16px] w-[300px] ms:w-[312px]">
...
//             </div>
//           </div>
//           <div className="w-[70px] md:w-[143px] h-[367px] flex md:justify-between justify-center md:gap-0 gap-[10px] flex-col  text-white cursor-pointer list-none  relative md:top-0 top-[230px] ">
...
//               Recent Post
//             </h2>
//             <div className="flex flex-col justify-center gap-[10px] relative md:top-[-120px] xl:top-[30px] xxl:top-[-120px] top-[-100px]">
