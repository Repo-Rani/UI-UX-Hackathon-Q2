...
const TestimonialCards = () => {
  ...
  return (
    <div className="w-[320px] h-[200px] md:w-[868.47px] md:h-[450px] relative left-[25px] md:left-[220px] xl:left-0 md:bottom-[170px] bottom-[150px] bg-[#ffffff] shadow-custom">
