...
{/* For desktop screens */}
    ...
    />            <span className="font-helvetica text-[18px] font-normal text-[#333333]">
      ...
      <div className="w-[248px] h-[87px] absolute  top-[1420px]  xxxl:left-[1333px] xl:left-[1080px] lg:left-[720px] xxl:left-[1140px]  flex flex-col justify-between ">
      ...
      <div className="w-[252px] h-[368px] absolute top-[1530px] xxl:top-[1540px] xxxl:left-[1338px] lg:left-[720px] xl:left-[1080px] xxl:left-[1150px] ">
    ...
    {/* For mobile screen */}
     <button
        className="block sm:hidden fixed top-[510px] right-4  hover:bg-black bg-[#ff9f0d] z-40 p-2 rounded-full "
  ...
  } sm:translate-x-0 fixed md:static top-0 left-0 z-40 sm:hidden flex h-full w-full bg-white md:bg-transparent text-black ms:p-5 md:p-0 transform transition-transform duration-300 ${
...
<div
        ...
        >
          <button
            className="sm:hidden mb-4 self-end text-black mt-4  ms:mr-[-25px]"
            onClick={toggleSidebar}
          >
            <FiX className="text-[24px]" />
            </button>

    <div className=" ms:w-[312px] w-[290px] h-[1489px] left-[15px]  ms:left-0 xsm:left-[20px] relative top-[-30px] border-[1px] rounded-[6px] border-[#f2f2f2] ">
