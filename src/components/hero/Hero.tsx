...
const HeaderHero = () => {
  return (
    <>
      {/* Hero Section */}
      <section className=" relative mx-auto max-w-[1920px]  bg-opacity-80  w-full bg-[#0d0d0d]  xl:h-[950px] h-[500px]  text-white flex justify-center items-center  ">
       <HeroBanner/>
      </section>
      {/* About us section */}
      <section className="w-full xl:w-[1320px] xl:h-[562px]  h-[750px] absolute xl:top-[1070px] flex justify-center  items-center    bg-black">
        <HeroAboutUs/>
      </section>
      ...
      {/* Clients section */}
      <section className="absolute xl:top-[2000px] top-[3500px]">
        <Clients />
      </section>
