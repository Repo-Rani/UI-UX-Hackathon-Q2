...
const ShopCard: React.FC = () => {
  ...
  return (
    <div className="product-list mt-24">
      ...
      {/* Pagination Section */}
           <div className="absolute xl:top-[2700px] top-[2500px] sm:top-[1900px] md:top-[2550px] lg:top-[2000px] xl:left-[380px] md:left-0 lg:left-[200px] xxxl:left-[635px] sm:left-[100px]">
        <Pagination
