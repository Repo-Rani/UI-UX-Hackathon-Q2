...
const Testimonial = () => {
  ...
  return (
     <section className=' absolute top-[2850px] xl:top-[3290px] xsm:top-[3000px] sm:top-[2600px]  md:top-[2900px] md:left-[20px] sm:left-[70px] lg:left-[100px] xxl:left-[300px] xl:left-[170px]'>
...
k"
      ...
      <div className="relative top-[270px] xsm:left-[30px] xlg:left-0 md:left-0 ">
        <TestimonialCards />
      </div>
      </div>
      </div>
